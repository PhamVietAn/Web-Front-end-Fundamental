let num1 = +prompt("Phương trình bậc 2 có dạng: ax^2 + bx + c = 0\nNhập số a");
let num2 = +prompt("Phương trình bậc 2 có dạng: ax^2 + bx + c = 0\nNhập số b");
let num3 = +prompt("Phương trình bậc 2 có dạng: ax^2 + bx + c = 0\nNhập số c");
